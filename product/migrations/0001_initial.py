# Generated by Django 3.2 on 2024-04-27 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('des_file', models.FileField(null=True, upload_to='type_files/')),
            ],
        ),
        migrations.CreateModel(
            name='VPS',
            fields=[
                ...
                ('operation_system', models.IntegerField(choices=[(0, 'windows'), (1, 'linux')], null=True)),
                ...
                ('expire_date', models.DateField(default=datetime.date(2025, 4, 27))),
                ('note', ckeditor.fields.RichTextField(default='', null=True)),
                ('bill_file', models.ImageField(null=True, upload_to='bill_files_VBShosting/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_date', models.DateField(default=datetime.date(2025, 4, 27))),
                ('note', ckeditor.fields.RichTextField(default='', null=True)),
                ('bill_file', models.ImageField(null=True, upload_to='bill_files_resdomain/')),
                ('my_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_date', models.DateField(default=datetime.date(2025, 4, 27))),
                ('note', ckeditor.fields.RichTextField(default='', null=True)),
                ('bill_file', models.ImageField(null=True, upload_to='bill_files_hostdomain/')),
                ('my_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
